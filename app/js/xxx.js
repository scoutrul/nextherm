		...
		element: $('.screen1'),
			enter: function(direction) {
				...
				setTimeout(function(){
					...
					var water = new Vivus('water', {type: 'oneByOne', duration: 200});
				}, 2000)
				setTimeout(function(){
					$('.icons svg:nth-child(2)').css('opacity','1');
					var term = new Vivus('term', {type: 'oneByOne', duration: 200});
				}, 3000)
				setTimeout(function(){
					$('.icons svg:nth-child(3)').css('opacity','1');
					var wind = new Vivus('wind', {type: 'oneByOne', duration: 400});
				}, 4000)
			},
			exited: function(direction) {
